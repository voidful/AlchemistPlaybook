...
| PivotRL (NVIDIA, Nemotron-3-Super) | arXiv 2603.21383 | turn-level local RL on SFT trajectories: pivot filtering (keep mixed-outcome, below-λ_diff turns; 71% of random turns give zero group-normalized gradient) + functional-equivalence verifier reward (exact match underperforms SFT: 57.34 vs 58.44 τ²-bench); GRPO-clipped objective + KL to frozen π₀; vs SFT same data: in-domain +14.11 vs +9.94, OOD +0.21 vs −9.48; ≈E2E-RL on SWE-Bench at 4× fewer rollout turns; G/K/λ_diff/LR not verifiable from accessible text |
